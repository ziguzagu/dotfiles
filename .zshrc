...
alias rg="rg --heading --colors 'match:fg:214' --colors 'match:style:nobold' --colors 'match:style:underline' --colors 'line:fg:117' --colors 'path:fg:250' --colors 'path:bg:238'"
alias l="ls -lh"
alias ll="ls -Alh"
